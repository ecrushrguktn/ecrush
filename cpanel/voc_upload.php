...
<head>
        ...
        <title> Vocabulary Upload || E-Crush</title>    
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">                                    
                                    <h4 class="page-title">Vocabulary Upload</h4>                                                                       
                            ...
                            <div class="col-md-6">
                                <div class="card-box">
                                    <h4 class="text-dark  header-title m-t-0">Vocabulary Upload</h4><hr>
                                    <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="date" placeholder="YY-MM-DD" class="form-control" name="dates" required="" value="<?php echo  date('Y-m-d')?>"><br>
                                        <input type="text" placeholder="Word" class="form-control" name="word" required><br>
                                        <input type="text" placeholder="Meaning" class="form-control" name="meaning" required><br>
                                        <input type="text" placeholder="Synonyms" class="form-control" name="synonyms" required><br>
                                        <input type="text" placeholder="Usage" class="form-control" name="usage" required><br>
