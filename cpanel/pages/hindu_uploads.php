   ...
   $filename = $_FILES['file']['name'];   
    ...
    else 
    {
      ...
      exit;
        ...
        $key=md5($filename);
       $r=mysqli_query($con,"SELECT * FROM newspapers where date='$dates' and type='hindu'"); 
       $c=mysqli_num_rows($r);       
       if($c<=0){
          $o=mysqli_query($con,"INSERT INTO newspapers(paper,date,added_by,added_ip,encrypt_key,type) VALUES('$withoutExt','$dates','$session','$ip','$key','hindu')");
          if($o==true){
            echo "11";
          }else{
            echo "22";
