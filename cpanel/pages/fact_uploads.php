   ...
   $filename = $_FILES['file']['name'];   
    ...
    else 
    {
      ...
      exit;
       ...
       $r=mysqli_query($con,"SELECT * FROM eskills_facts where dates='$dates'"); 
       $c=mysqli_num_rows($r);       
       if($c<=0){
          $o=mysqli_query($con,"INSERT INTO eskills_facts(fact,dates,added_by,added_ip) VALUES('$filename','$dates','$session','$ip')");
          if($o==true){
            echo "11";
          }else{
            echo "22";
