...
<head>
        ...
        <title> Send Notice || E-Crush</title>    
     ...
     fclose($fp);                            
      ...
      foreach ($_FILES["file_img"]["error"] as $key => $error) {
        ...
        exit;
          ...
          $ip=$_SERVER['REMOTE_ADDR'];          
          $l=mysqli_query($con,"INSERT INTO notices (subject,description,sent_to,sent_by,sent_date,sent_ip,sent_os,sent_browser,file,files_count,department,added_by,user_type,notice_visible) VALUES ('$brand','$pro','$pr','$sent_by','$date','$ip','$user_os','$user_browser','$images_name','$c','$dep','$session','$added_by','$time') ");   
          if($l==true){
            mysqli_query($con,"INSERT INTO notices_logs (subject,description,sent_to,sent_by,sent_date,sent_ip,sent_os,sent_browser,file,files_count,status,department,added_by,notice_visible) VALUES ('$brand','$pro','$pr','$sent_by','$date','$ip','$user_os','$user_browser','$images_name','$c','Added Succesfully with file','$dep','$session','$time') ");   
              echo'<script>alert("Succesfully Sent")</script>';
          }else{
            mysqli_query($con,"INSERT INTO notices_logs (subject,description,sent_to,sent_by,sent_date,sent_ip,sent_os,sent_browser,file,files_count,status,department,added_by,notice_visible) VALUES ('$brand','$pro','$pr','$sent_by','$date','$ip','$user_os','$user_browser','$images_name','$c','fields are Missing with file','$dep','$session','$time') ");
              echo'<script>alert("Some fields are missing")</script>';
          }
        }
      }else{
        $ip=$_SERVER['REMOTE_ADDR'];          
          $l=mysqli_query($con,"INSERT INTO notices (subject,description,sent_to,sent_by,sent_date,sent_ip,sent_os,sent_browser,department,added_by,user_type,notice_visible) VALUES ('$brand','$pro','$pr','$sent_by','$date','$ip','$user_os','$user_browser','$dep','$session','$added_by','$time') ");   
          if($l==true){
            mysqli_query($con,"INSERT INTO notices_logs (subject,description,sent_to,sent_by,sent_date,sent_ip,sent_os,sent_browser,status,department,added_by,notice_visible) VALUES ('$brand','$pro','$pr','$sent_by','$date','$ip','$user_os','$user_browser','Added Succesfully without file','$dep','$session','$time') ");
              echo'<script>alert("Succesfully Sent")</script>';              
          }else{
            mysqli_query($con,"INSERT INTO notices_logs (subject,description,sent_to,sent_by,sent_date,sent_ip,sent_os,sent_browser,status,department,added_by,notice_visible) VALUES ('$brand','$pro','$pr','$sent_by','$date','$ip','$user_os','$user_browser','Fields are Missing without file','$dep','$session','$time') ");
              echo'<script>alert("Some fields are missing")</script>';
          }
                ...
                <div class="content">
                    <div class="container-fluid">
                       ...
                       <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <h4 class="text-dark  header-title m-t-0">Send Notice</h4><hr>
        ...
        <div class="alert alert-info"> 
          ...
          <table class="table table-bordered table-stripped">
                  ...
                  <td>                    
                    ...
                    <td>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Subject" name="subject" required="">
                    </td>
                    </div>
                  </tr>
                  <tr>
                  ...
                  <td>
                    <div class="row">
                      <div class="col-md-1">
                      <input type="radio" name="sent_to" value="ALL" onclick="show2()" checked="">&nbsp;ALL
                    </div>
                    <!-- <div class="col-md-1">
                      <input type="radio" name="sent_to" value="PUC" onclick="show2()">&nbsp;PUC
                    </div>
                    <div class="col-md-1">
                      <input type="radio" name="sent_to" value="ENGG" onclick="show2()">&nbsp;ENG
                    </div> -->
                     <!-- <div class="col-md-1">
                      <input type="radio" name="sent_to" value="P1_N" onclick="show2()">&nbsp;P1_N
                    </div> -->
                    <div class="col-md-1">
                      <input type="radio" name="sent_to" value="P1" onclick="show2()">&nbsp;P1
                    </div>
                     <div class="col-md-1">
                      <input type="radio" name="sent_to" value="P2" onclick="show2()">&nbsp;P2
                    </div>
                    <!--  <div class="col-md-1">
                      <input type="radio" name="sent_to" value="E1_N" onclick="show1()">&nbsp;E1_N
                    </div> -->
                    <div class="col-md-1">
                      <input type="radio" name="sent_to" value="E1" onclick="show1()">&nbsp;E1
                    </div>
                     <div class="col-md-1">
                      <input type="radio" name="sent_to" value="E2" onclick="show1()">&nbsp;E2
                    </div>
                     <div class="col-md-1">
                      <input type="radio" name="sent_to" value="E3" onclick="show1()">&nbsp;E3
                    </div>
                     <div class="col-md-1">
                      <input type="radio" name="sent_to" value="E4" onclick="show1()">&nbsp;E4
                    </div>
                    </div>
                  </td>
                    </div> 
