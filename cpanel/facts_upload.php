...
<head>
        ...
        <title> Fact Upload || E-Crush</title>    
                ...
                $("#form").on('submit',(function(e) {
                    ...
                    success: function(check){                           
                        if(check==11){
                            ...
                            $("#btn-send").html('Upload');
                            $.Notification.autoHideNotify('error', 'bottom right', 'Hey mage Not Uploaded !!','Image Not Uploaded...Try Again');
                        }else if(check==55){
                            $("#btn-send").html('Upload');
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">                                    
                                    <h4 class="page-title">Fact Upload</h4>                                                                       
                       ...
                       <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <h4 class="text-dark  header-title m-t-0">Fact Upload</h4><hr>
