...
<head>
        ...
        <title> Hindu Upload || E-Crush</title>    
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">                                    
                                    <h4 class="page-title">Hindu Upload</h4>                                                                       
                       ...
                       <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <h4 class="text-dark  header-title m-t-0">Hindu Upload</h4><hr>
                                    <form id="form" action="fact_uploads.php" method="post" enctype="multipart/form-data">  
                                            <select name="category" class="form-control">
                                                    <option>Select Category</option>
                                                    <option value="Reading" onclick="reading()">Reading</option>
                                                    <option value="Writing" onclick="writing()">Writing</option>
                                                    <option value="Grammar" onclick="grammar()">Grammar</option>    
                                                    <option value="Softwares" onclick="softwares()">Softwares</option>
                                                    <option value="Placements" onclick="placements()">Placements</option>                                                    
                                            </select><br>
                                                ...
                                                <div id="writings" style="display:none;">
                                                    <select name="sub_category" class="form-control">                                                
                                                        <option value="">Select Sub Category</option>
                                                ...
                                                <div id="softwares" style="display:none;">
                                                    <select name="sub_category" class="form-control">                                                
                                                        <option value="">Select Sub Category</option>
                                                ...
                                                <div id="placements" style="display:none;">
                                                    <select name="sub_category" class="form-control">                                                
                                                        <option value="">Select Sub Category</option>
                                                 ...
                                                 <div id="grammars" style="display:none;">
                                                    <select name="sub_category" class="form-control">                                                
                                                            <option value="">Select Sub Category</option>
