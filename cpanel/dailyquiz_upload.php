...
<head>
        ...
        <title> Daily GK Upload || E-Crush</title>    
                ...
                $("#form").on('submit',(function(e) {
                    ...
                    success: function(check){                           
                        if(check==11){
                            ...
                            $("#btn-send").html('Upload');
                            $.Notification.autoHideNotify('error', 'bottom right', 'Hey Server Error !!','Some error occured at server'+check+'');
                        }
                    }
                });
                    return false;
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">                                    
                                    <h4 class="page-title">Daily GK Upload</h4>                                                                       
                            ...
                            <div class="col-md-10">
                                <div class="card-box">
                                    <h4 class="text-dark  header-title m-t-0">Daily GK Upload</h4><hr>
                                    <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="date" placeholder="YY-MM-DD" class="form-control" name="dates" required="" value="<?php echo  date('Y-m-d')?>"><br>
                                        <input type="text" placeholder="Question" class="form-control" name="question" class="form-control" required><br>
                                        <input type="text" placeholder="Option1" class="form-control" name="option1" required><br>
                                        <input type="text" placeholder="Option2" class="form-control" name="option2" required><br>
                                        <input type="text" placeholder="Option3" class="form-control" name="option3" required><br>
                                        <input type="text" placeholder="Option4" class="form-control" name="option4" required><br>
