...
<head>
        ...
        <title>Leaderboard (Weekly) || E-Crush</title>                
...
<div id="jssor_1" style="position:relative;margin:0 auto;top:30px;left:0px;width:1100px;height:150px;overflow:hidden;visibility:hidden;">        
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1100px;height:150px;overflow:hidden;">
            ...
            $date=date('Y-m-d'); 
            $week = date('W');           
            $q=mysqli_query($con,"SELECT * FROM leaderboard_weekly where week='$week' order by points DESC limit 10");            
            $c=mysqli_num_rows($q);
            while($r=mysqli_fetch_array($q,MYSQLI_BOTH)){
            ?>
            <div data-p="43.75">
                <a href="#"><img data-u="image" src="Profile/images/<?php echo $r['profile_img']; ?>" / style="border-radius:10px;"></a>
            </div>
           <?php } ?>
        </div>
    </div>
    ...
    <div class="col-md-12">                        
        ...
        <div class="table-responsive">
          ...
          <tbody>
            <?php   
            $i=1;          
            $q=mysqli_query($con,"SELECT * FROM leaderboard_weekly where week='$week' order by points DESC limit 50");               
            while($r=mysqli_fetch_array($q,MYSQLI_BOTH)){
              echo'
              <tr>
            ...
            echo'<center><div class="alert alert-danger alert-dismissible" style="width:100%">
                ...
                <h4><i class="icon fa fa-ban"></i><strong>Not Available!</strong></h4>
                Sorry Leaderboard Scores of  Week '.$week.' are not available.Please visit Later.
              </div></center>';
          }
            ?>                                  
          </tbody>         
